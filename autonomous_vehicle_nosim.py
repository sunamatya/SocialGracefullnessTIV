...
class AutonomousVehicle:
    ...
    def multi_search_intent(self):
        ...
        posterior_joint_probability_out = posterior_joint_probability_out / sum(posterior_joint_probability_out)
        ...
        for i in range(len(posterior_joint_probability_out)):
            p_joint = posterior_joint_probability_out[i]
            theta_i = theta_self_out[i]
            theta_j = theta_other_out[i]
            if theta_i == 1 and theta_j == 1:
                joint_probability_matrix[0, 0] = p_joint
            elif theta_i == 1 and theta_j == 1000:
                joint_probability_matrix[0, 1] = p_joint
            elif theta_i == 1000 and theta_j == 1:
                joint_probability_matrix[1, 0] = p_joint
            elif theta_i == 1000 and theta_j == 1000:
                joint_probability_matrix[1, 1] = p_joint
            else:
                print("invalid combo ", theta_i," ", theta_j)
    ...
    def dynamic(self, action_self, position_error_other=[0], velocity_error_other=[0], position_error_self = [0], velocity_error_self = [0]):
